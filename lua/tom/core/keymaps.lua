...
keymap.set('i', '<C-c>', '<C-c>', { noremap = true })
...
vim.api.nvim_set_keymap('n', '<leader>dr', "<cmd>lua require('csharp').run_project()<CR>", { noremap = true, silent = true })

vim.api.nvim_set_keymap('n', '<leader>dg', "<cmd>lua require('csharp').debug_project()<CR>", { noremap = true, silent = true })

vim.api.nvim_set_keymap('n', '<leader>gd', "<cmd>lua require('csharp').go_to_definition()<CR>", { noremap = true, silent = true })
